  ...
  levelKeys.forEach((key, index) => {
    if (data[key]) {
      const translatedName =
        language === "hi" ? DASHA_LEVEL_MAP[key] : DASHA_LEVEL_MAP_EN[key];
      levels.push({
        ...data[key],
  ...
  if (levels.length === 0) {
    return (
      <div className="no-data-msg">
        {language === "hi"
          ? "दशा जानकारी उपलब्ध नहीं है"
          : "No dasha information available"}
        .
      </div>
    );
  }
...
export default function DashaPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(
        err.message ||
          "दशा विवरण प्राप्त करने में विफल (Failed to get dasha details).",
      );
    } finally {
      setIsLoading(false);
    }
  ...
  return (
    <div className="dasha-page-container">
      <SeoMeta
        title="Vimshottari Dasha | NakshatraPath Astrology"
      ...
      <div className="sacred-header">
        ...
        <p className="subtitle">
          {language === "hi"
            ? "वैदिक काल चक्र विश्लेषण"
            : "Vedic Time Cycles Analysis"}
        </p>
      </div>
      ...
      <div className="sacred-content">
        ...
        <section className="results-container">
          ...
          {isLoading && (
            <LoadingSpinner label="दशा अवधियों की गणना हो रही है..." />
          )}
